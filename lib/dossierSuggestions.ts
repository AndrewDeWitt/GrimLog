...
import { DossierContext, DossierStrategicAnalysis, ListSuggestion } from './dossierAnalysis';
 ...
 *
 * @param context - Current army composition (DossierContext)
 ...
 */
function formatCurrentArmyUnit(unit: DossierContext['units'][0]): string {
  const lines: string[] = [];
