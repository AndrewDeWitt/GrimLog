 ...
 * Brief HTML Export
 *
 * Generates a self-contained HTML file with the tactical brief report.
...
/**
 * Generate a complete, self-contained HTML file for the brief
...
<head>
  ...
  <title>Tactical Brief - ${listName || 'Army Analysis'}</title>
  <style>
    ${getInlineStyles()}
  </style>
</head>
  ...
  <div class="container">
    ...
    <header class="header">
      <div class="header-content">
        <h1 class="title">⚔ TACTICAL BRIEF</h1>
    ...
    <!-- Footer -->
    <footer class="footer">
      <p>Generated by Grimlog Tactical Brief Engine • ${generatedTimestamp}</p>
