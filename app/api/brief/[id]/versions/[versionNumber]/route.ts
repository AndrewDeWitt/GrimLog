/**
 * Brief Version Detail API
 *
 * GET /api/brief/[id]/versions/[versionNumber] - Get specific version snapshot
 */
...
/**
 * GET /api/brief/[id]/versions/[versionNumber]
  ...
  try {
    ...
    return NextResponse.json({
      version: {
        ...
        isCurrent: version.versionNumber === brief.currentVersion,
      },
      snapshot,
    });
    ...
    console.error('Brief version GET error:', error);
    return NextResponse.json(
