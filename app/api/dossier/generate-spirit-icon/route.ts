 ...
 * 
 * POST /api/dossier/generate-spirit-icon
 * 
 * Generates a unique grimdark comic book style icon for an army
 * based on the AI-generated image prompt from dossier analysis.
 * 
 * NOTE: This endpoint still exists for backwards compatibility,
 * but spirit icons are now generated as part of the /api/dossier/submit background flow.
 * 
