/**
 * Dossier List API Endpoint
 *
 * GET /api/dossier/list - List user's dossier history
 */
 ...
 * List user's dossier history with pagination and filtering
 *
 * Query params:
