...
interface BriefEditToolbarProps {
...
/**
 * BriefEditToolbar - Contextual toolbar shown when in edit mode
 *
 * Shows Save, Discard, and Done buttons
 * Save always creates a version (opens modal for optional label/notes)
 */
export function BriefEditToolbar({
  hasUnsavedChanges,
  onSave,
  onDiscard,
  onDone,
  isSaving,
}: BriefEditToolbarProps) {
  return (
...
export default BriefEditToolbar;
