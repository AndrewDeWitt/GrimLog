...
import sampleData from '@/data/sample-brief-response.json';
...
// Playstyle config matching BriefReport
...
interface BriefSamplePreviewProps {
  onGenerateClick: () => void;
  ctaLabel?: string;
  ctaVariant?: 'orange' | 'green';
}

export function BriefSamplePreview({ onGenerateClick, ctaLabel = '⚔ Generate Your Own Brief', ctaVariant = 'orange' }: BriefSamplePreviewProps) {
  ...
  return (
    <section className="py-6 md:py-6 bg-grimlog-darkGray">
      <div className="container mx-auto px-2 md:px-4 max-w-5xl">
        ...
        {/* Sample Brief - matches BriefReport styling */}
...
export default BriefSamplePreview;
