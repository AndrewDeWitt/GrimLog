...
interface MyDossiersMobileFilterPanelProps {
  ...
  // Visibility filter (unique to My Dossiers)
...
/**
 * Mobile slide-up panel for My Dossiers filters.
 * Extends the base MobileFilterPanel with search and visibility filter.
 */
export default function MyDossiersMobileFilterPanel({
  isOpen,
  onClose,
  searchQuery,
  onSearchChange,
  ...
  activeFilterCount,
}: MyDossiersMobileFilterPanelProps) {
