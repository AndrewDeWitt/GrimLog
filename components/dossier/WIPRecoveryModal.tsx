...
import { DossierWIPData } from '@/hooks/useDossierAutoSave';

interface WIPRecoveryModalProps {
  isOpen: boolean;
  wipData: DossierWIPData | null;
          ...
          {isOutdated && (
            <div className="p-3 bg-grimlog-amber/10 border border-grimlog-amber/30 rounded">
              <p className="text-grimlog-amber text-sm">
                <span className="font-bold">Warning:</span> The dossier has been updated since
